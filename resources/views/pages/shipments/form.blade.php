    ...
    <div class="col-md-6">
        <div class="form-group">
          ...
          data-addressc="{{ $var->address }}" @endforeach
                        data-branchc="{{ $client->branch_id }}" data-email="{{ $client->email }}">
                        {{ $client->name }}
                    </option>
                @endforeach
            </select>
    ...
    <div class="col-md-8">
        <div class="form-group">
            ...
            <input type="file" name="attachments_before_shipping[]" id="attachments_before_shipping"
                ...
                class="form-control d-none @error('attachments_before_shipping') is-invalid @enderror" multiple />
            <input type="file" name="capturedImages[]" id="capturedImages" accept=".jpg,.jpeg,.png,.pdf"
                class="form-control d-none @error('capturedImages') is-invalid @enderror" multiple />
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" name="hazmat" id="hazmat" class="form-control" step="0.01" min="0"
                value="{{ old('hazmat', $shipment->hazmat ?? '0') }}">
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" name="imo" id="imo" class="form-control" step="0.01" min="0"
                value="{{ old('imo', $shipment->imo ?? '0') }}">
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" name="handling" id="handling" class="form-control" step="0.01"
                min="0" value="{{ old('handling', $shipment->handling ?? '0') }}">
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="number" name="sed" id="sed" class="form-control" step="0.01" min="0"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div>
                ...
                <div id="volumetric_weight"
                    class="{{ empty(old('total_volumetric', $shipment->total_volumetric ?? null)) ? 'd-none' : '' }}">
                    Total volumetric:
                    {{ old('total_volumetric', isset($shipment) ? number_format($shipment->total_volumetric, 2) : '') }}
                </div>

                <div id="cubic_feet"
                    class="{{ empty(old('cubic_feet', $shipment->cubic_feet ?? null)) ? 'd-none' : '' }}">
                    Cubic feet:
                    {{ old('cubic_feet', isset($shipment) ? number_format($shipment->cubic_feet, 2) : '') }}
                </div>
...
@push('js')
    <script>
        $(document).ready(function() {
            $("#calculate-fn").on('click', function() {
                ...
                $packageItems.each(function() {
                    ...
                    volumetricWeight = Number((length * width * height) / 139);
                    cubic_feet = Number((length * width * height) / 1728)?.toFixed(2);
                ...
                $('#volumetric_weight').text('volumetric weight: ' + totalVolumetricWeight?.toFixed(2))
                    .removeClass(
                        "d-none");
                $("#cubic_feet").text('Cubic feet: ' + cubic_feet).removeClass("d-none");

                $("#volumetric_weight").append(
                    `<input type='hidden' class='d-none' name="total_volumetric" value=${totalVolumetricWeight}>`
                )
                $("#cubic_feet").append(
                    `<input type='hidden' class='d-none' name="cubic_feet" value=${cubic_feet}>`
                )
            })
            ...
            (function($) {
                ...
                function calcTotalWeight() {
                    ...
                    $packageItems.each(function() {
                        ...
                        var volumetricWeight = Number((length * width * height) / 139)?.toFixed(2);
                        var cubic_feet = Number((length * width * height) / 1728)?.toFixed(2);

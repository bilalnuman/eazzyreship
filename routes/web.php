...
Route::middleware('role:admin','auth', 'verified')->group(function () {
    ...
    Route::get('/shipment/send-invoice', [ShipmentController::class, 'sendInvoice'])->name('pages.shipments.sendinvoice');
    ...
    Route::get('/shipment/attachments/{id}', [ShipmentController::class, 'attachments'])->name('shipment.attachments');
